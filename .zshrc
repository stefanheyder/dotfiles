...
plugins=(git yarn npm vagrant vi-mode laravel5 tmux)

source $ZSH/oh-my-zsh.sh

# remove delay after pressing <ESC> to start vi-mode
export KEYTIMEOUT=1
...
reload_aliases () {
    ...
    for file in $ALIAS_FILES; do
        ...
        if [[ $LAST_RELOAD < $(noglob stat -c %Y ${file}) ]]; then
            echo "$file has changed, reloading ~/.zshrc"
            source ~/.zshrc
